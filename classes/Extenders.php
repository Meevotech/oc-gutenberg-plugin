...
use Meevo\Gutenberg\Models\Settings;
use Meevo\Gutenberg\Helpers\BlockHelper;
            ...
            Event::listen('backend.form.extendFields', function ($widget) {
                ...
                foreach ($widget->getFields() as $field) {
                    if ($field->fieldName === 'content') {
                        ...
                        $field->config['widget'] = 'Meevo\Gutenberg\FormWidgets\Gutenberg';
